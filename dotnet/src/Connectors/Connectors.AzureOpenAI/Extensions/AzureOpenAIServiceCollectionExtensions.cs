...
public static class AzureOpenAIServiceCollectionExtensions
{
        ...
        FunctionPolicies? functionPolicies = null)
    {
        ...
        Func<IServiceProvider, object?, AzureOpenAIChatCompletionService> factory = (serviceProvider, _) =>
        {
            ...
            return new(deploymentName, client, modelId, serviceProvider.GetService<ILoggerFactory>(), functionPolicies: functionPolicies);
        };
        ...
        FunctionPolicies? functionPolicies = null)
    {
        ...
        Func<IServiceProvider, object?, AzureOpenAIChatCompletionService> factory = (serviceProvider, _) =>
            new(deploymentName, azureOpenAIClient ?? serviceProvider.GetRequiredService<AzureOpenAIClient>(), modelId, serviceProvider.GetService<ILoggerFactory>(), functionPolicies: functionPolicies);
