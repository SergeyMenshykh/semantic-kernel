...
public static class KernelExtensions
{
    ...
    /// See <see cref="KernelFunctionAttribute"/> attribute for details.
    /// </remarks>
    public static KernelPlugin AddFromObject(this ICollection<KernelPlugin> plugins, JsonSerializerOptions jsonSerializerOptions, object target, string? pluginName = null, IServiceProvider? serviceProvider = null)
    {
        Verify.NotNull(plugins);
